...
export class ProgrammerProfileFormComponent implements OnInit {
  ...
  createDisponibilidadGroup() {
    ...
    }, { validators: timeRangeValidator }); // ⬅️ Aplicamos el validador de rango al FormGroup
  }
  ...
  onSubmit() {
    ...
    // this.http.put(APP_ROUTES.main.childrens.perfilProgramador_edit.apiPath, payload);
  }
